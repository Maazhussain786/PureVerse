...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      >
        {/* Android App Promotion Button */}
        <div className="mb-8 flex justify-start">
          <a
            href="https://github.com/Maazhussain786/PureVerse/releases/latest/download/PureVerse.apk"
            download
            aria-label="Download Android App"
            className="inline-flex items-center justify-center gap-2 h-10 md:h-[46px] px-4 md:px-5 rounded-md bg-[rgba(163,230,53,0.15)] border border-[var(--accent-primary)]/30 text-[var(--accent-primary)] font-semibold text-[13px] md:text-[14px] backdrop-blur-md transition-all hover:bg-[var(--accent-primary)] hover:text-black hover:shadow-[0_0_15px_var(--accent-glow)] active:scale-[0.98]"
          >
            ...
            <span className="whitespace-nowrap">Get Android App</span>
          </a>
        </div>
