  ...
  return (
    <main className="min-h-screen">
      ...
      >
        ...
        <div className="mb-10 lg:mb-12 w-full rounded-2xl bg-gradient-to-r from-[rgba(163,230,53,0.12)] to-transparent border border-[var(--accent-primary)]/20 p-5 md:p-6 flex flex-col sm:flex-row items-center justify-between gap-5 backdrop-blur-md">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 flex-shrink-0 rounded-full bg-[var(--accent-primary)]/20 flex items-center justify-center">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="var(--accent-primary)">
                <path d="M17.523 15.3414c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9993.9993-.9993c.5511 0 .9993.4482.9993.9993.0004.5511-.4482.9997-.9993.9997m-11.046 0c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9993.9993-.9993c.5511 0 .9993.4482.9993.9993 0 .5511-.4482.9997-.9993.9997m11.4045-6.02l1.9973-3.4592a.416.416 0 00-.1521-.5676.416.416 0 00-.5676.1521l-2.0222 3.503C15.5902 8.2435 13.8533 7.8546 12 7.8546c-1.8533 0-3.5902.3889-5.1369 1.0958L4.841 5.4473a.416.416 0 00-.5676-.1521.416.416 0 00-.1521.5676l1.9973 3.4592C2.6889 11.1867.3432 14.6589 0 18.761h24c-.3432-4.1021-2.6889-7.5743-6.1185-9.4396" />
              </svg>
            </div>
            <div>
              <h3 className="text-lg md:text-xl font-bold text-white mb-1">Take PureVerse anywhere</h3>
              <p className="text-sm text-[var(--text-secondary)]">Download our Android app to watch on the go.</p>
            </div>
          </div>
          <a
            href="https://github.com/Maazhussain786/PureVerse/releases/latest/download/PureVerse.apk"
            download
            className="flex-shrink-0 w-full sm:w-auto inline-flex items-center justify-center gap-2 h-11 px-6 rounded-md bg-[var(--accent-primary)] text-black font-bold text-[15px] transition-all hover:bg-[var(--accent-primary)]/90 hover:shadow-[0_0_20px_var(--accent-glow)] active:scale-[0.98]"
          >
            Download Now
          </a>
        </div>
