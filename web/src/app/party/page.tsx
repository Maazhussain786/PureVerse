...
export default function PartyLobbyPage() {
  ...
  return (
    <main className="min-h-screen pt-24 pb-28 lg:pb-16 px-5 md:px-10 lg:px-14 max-w-[1400px] mx-auto">
      {/* ─── Hero ─── */}
      <section className="relative overflow-hidden rounded-3xl border border-white/[0.07] mb-10">
        ...
        <div className="relative p-7 md:p-12 flex flex-col md:flex-row md:items-center gap-8">
          <div className="flex-1">
            <p className="text-[11px] font-black uppercase tracking-[0.25em] text-[var(--accent-teal)] mb-3">
              PureVerse Watch Party
            </p>
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-3" style={{ fontFamily: "var(--font-space)" }}>
          ...
          <div className="w-full md:w-80 flex-shrink-0">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-5 py-3 rounded-xl text-sm font-bold text-black bg-[var(--accent-teal)] hover:shadow-[0_0_18px_var(--accent-teal-glow)] transition-all disabled:opacity-40 flex-shrink-0"
              >
                Join
              </button>
            </div>
      ...
      <section className="mb-12">
        ...
        {!roomsLoaded ? (
          ...
          <div className="glass-panel rounded-2xl p-10 text-center">
            <p className="text-sm text-[var(--text-muted)] mb-1">No public rooms right now.</p>
      ...
      {/* ─── Start a party ─── */}
      <section>
        <h2 className="text-lg md:text-xl font-bold text-white mb-1" style={{ fontFamily: "var(--font-space)" }}>
          Start a party
        </h2>
        ...
        {continueWatching.length > 0 && (
          <>
            <h3 className="text-[11px] font-black uppercase tracking-widest text-[var(--text-secondary)] mb-3">
              From your continue watching
            </h3>
            <div className="flex gap-3 overflow-x-auto hide-scrollbar pb-2 mb-7">
                ...
                >
                  <div className="aspect-[2/3] rounded-xl overflow-hidden bg-[var(--bg-elevated)] ring-1 ring-white/10 group-hover:ring-[var(--accent-teal)]/60 transition-all relative">
                    ...
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <span className="px-3 py-1.5 rounded-full bg-[var(--accent-teal)] text-black text-[10px] font-black">
                        + PARTY
                      </span>
                    </div>
                  </div>
                ...
                <button
                  ...
                  onClick={() =>
                    setCreateSeed({
                      ...
                      season: item.type === "movie" ? undefined : 1,
                      episode: item.type === "movie" ? undefined : 1,
                    })
                  }
                  className="group flex-shrink-0 w-[120px] text-left"
                >
